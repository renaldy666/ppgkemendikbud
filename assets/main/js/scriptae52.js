...
$(document).ready(function ($) {
	...
	/* ---------------------------------------------------------------------- */
    try {
        var fenway = [-6.224907217406276, 106.80303697599795]; //Change a map coordinate here!
        var markerPosition = [-6.224907217406276, 106.80303697599795]; //Change a map marker here!
        $("#map")
            .gmap3({
                center: fenway,
                zoom: 18,
